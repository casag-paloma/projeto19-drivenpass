...
function createWifi(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const data = req.body;
        yield wifiService.createWifi(userId, data);
        res.sendStatus(201);
    });
}
...
function getWifi(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { userId } = res.locals.tokenData;
        const wifis = yield wifiService.getWifis(userId);
...
function getWifiById(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const wifi = yield wifiService.getWifiById(Number(id), userId);
...
function deleteWifi(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (isNaN(Number(id)))
            return res.sendStatus(422);
        yield wifiService.deleteWifi(Number(id), userId);
        res.sendStatus(204);
    });
}
